...
import 'taker_copy_model.dart';
export 'taker_copy_model.dart';

class TakerCopyWidget extends StatefulWidget {
  const TakerCopyWidget({Key? key}) : super(key: key);

  @override
  _TakerCopyWidgetState createState() => _TakerCopyWidgetState();
}

class _TakerCopyWidgetState extends State<TakerCopyWidget> {
  late TakerCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TakerCopyModel());
